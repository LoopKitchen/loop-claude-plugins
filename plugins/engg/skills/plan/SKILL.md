---
name: plan
description: Create a detailed implementation plan as a GitHub issue. Use when the user wants to plan, design, or architect a feature or change before implementing it, including trade-offs and multiple approaches.
---
